...
declare -r xctoolVars=$(xctool -showBuildSettings -workspace ../IMMSlackerClient.xcworkspace -scheme IMMSlackerClient | egrep '(BUILT_PRODUCTS_DIR)|(CURRENT_ARCH)|(OBJECT_FILE_DIR_normal)|(SRCROOT)|(OBJROOT)' |  egrep -v 'Pods')
while read line; do
